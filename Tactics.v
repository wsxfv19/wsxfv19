...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof.
  intros l l' eq1.  rewrite->eq1. rewrite->rev_involutive. reflexivity. Qed.
(** [] *)
...
(* If the condition is a subset of the target, 
rewrite and apply can be used. If there are deductive symbols in the condition, 
only apply can be used. *)
*)
(** [] *)
...
Theorem plus_n_n_injective : forall n m,
     ...
     n = m.
Proof.
  intros n. induction n as [| n']; intros;destruct m.
-reflexivity.
- inversion H.
-inversion H.
-apply->P.
...
-unfold combine. inversion H. rewrite H1.
+rewrite->H. reflexivity.
...
(** $Date: 2017-09-12 10:58:55 -0400 (Tue, 12 Sep 2017) $ *)
